...
$app->group(['prefix' => $prefix, 'namespace' => 'App\Http\Controllers'], function ($app) {
...
//$app->get('/setup/finish', ['as' => 'setup_finish', 'uses' => 'SetupController@finishSetup']);
    ...
    $app->post('/admin', ['as' => 'pshorten', 'uses' => 'LinkController@performShorten']);
...
$app->group(['prefix' => "$prefix/api/v2", 'namespace' => 'App\Http\Controllers'], function ($app) {
...
$app->group(['prefix' => "$prefix/api/v2", 'namespace' => 'App\Http\Controllers\Api', 'middleware' => 'api'], function ($app) {
