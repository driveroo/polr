...
@section('css')
<link rel='stylesheet' href='{{ env('APP_PROTOCOL') . env('APP_ADDRESS') }}/css/reset_password.css' />
@endsection
...
@section('js')
<script src='{{ env('APP_PROTOCOL') . env('APP_ADDRESS') }}/js/reset_password.js'></script>
@endsection
